...
namespace DormRoomMonitor
{
    ...
    public sealed partial class NewUserPage : Page
    {
        ...
        private StorageFile[] currentIdPhotoFiles;
        ...
        private async void Capture_Click(object sender, RoutedEventArgs e)
        {
            /*try
            {
                ...
                currentIdPhotoFiles = await webcam.CapturePhotos();
            ...
            {
                Debug.WriteLine("error in Capture_Click " + ex.Message);

                //await speech.Read(SpeechContants.exception(ex.Message, "Capture clicked"));
            }*/
        }
